...
public class JWTFilter extends OncePerRequestFilter {
    ...
    @Lazy
    //    Questo in mi permette di evitare la ricorrenza creando una sorta di injection in differita, non so se sia una best practice ma funziona, ho palesemente googlato
    @Autowired
